    ...
    <h1 class="text-3xl font-semibold mb-4">
      ...
      <div class="overflow-hidden shadow sm:rounded-md max-w-sm mx-auto text-left">
        ...
        <div class="bg-gray-50 px-4 py-3 text-right sm:px-6"> 
            <button @click="handleConfirmTrip" type="button" class="inline-flex justify-center rounded-md border border-transparent bg-black py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-gray-600 focus:outline-none">
              Let's Go!
            </button>
          </div>
      </div>
